          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg">
                ...
                <div className="text-lg font-semibold text-blue-600">hello@close2heart.com.au</div>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg">
                ...
                <div className="space-y-3 text-slate-600">
                  <div>
                    ...
                    <div className="text-sm">Serving Greater Sydney & surrounds</div>
                  </div>
                  <div>
                    <div className="font-semibold">Melbourne Office</div>
                    <div className="text-sm">Serving Greater Melbourne & surrounds</div>
                  </div>
                  <div>
